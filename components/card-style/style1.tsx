    ...
    return (
        <div className="bg-white">
            ...
            <div className="flex flex-wrap gap-5 justify-center w-5/6 mx-auto mt-4">
                <Phone className="w-12 h-12 bg-gradient-to-b from-orange-500 to-gray-500 p-2 text-white rounded-2xl" />
                <MessageSquare className="w-12 h-12 bg-gradient-to-b from-orange-500 to-gray-500 p-2 text-white rounded-2xl" />
                <MailPlus className="w-12 h-12 bg-gradient-to-b from-orange-500 to-gray-500 p-2 text-white rounded-2xl" />
                <BadgeCheck className="w-12 h-12 bg-gradient-to-b from-orange-500 to-gray-500 p-2 text-white rounded-2xl" />
                <Link2 className="w-12 h-12 bg-gradient-to-b from-orange-500 to-gray-500 p-2 text-white rounded-2xl" />
                <Facebook className="w-12 h-12 bg-gradient-to-b from-orange-500 to-gray-500 p-2 text-white rounded-2xl" />
                <Instagram className="w-12 h-12 bg-gradient-to-b from-orange-500 to-gray-500 p-2 text-white rounded-2xl" />
                <Twitter className="w-12 h-12 bg-gradient-to-b from-orange-500 to-gray-500 p-2 text-white rounded-2xl" />
                <Linkedin className="w-12 h-12 bg-gradient-to-b from-orange-500 to-gray-500 p-2 text-white rounded-2xl" />
                <Twitch className="w-12 h-12 bg-gradient-to-b from-orange-500 to-gray-500 p-2 text-white rounded-2xl" />
            </div>
